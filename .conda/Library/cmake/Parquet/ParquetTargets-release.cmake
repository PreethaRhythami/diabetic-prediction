...
set_target_properties(Parquet::parquet_shared PROPERTIES
  IMPORTED_IMPLIB_RELEASE "C:/Users/User/final project/.conda/Library/parquet.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/parquet.dll"
  )

list(APPEND _cmake_import_check_targets Parquet::parquet_shared )
list(APPEND _cmake_import_check_files_for_Parquet::parquet_shared "C:/Users/User/final project/.conda/Library/parquet.lib" "${_IMPORT_PREFIX}/bin/parquet.dll" )
